...
In late june/early july this year I went to San Francisco for [devopsday USA 2010](http://www.devopsdays.org/2010-us/) that I had the pleasure to co-organize with [Damon Edwards](http://twitter.com/damonedwards), [Patrick Debois](http://twitter.com/patrickdebois) and [Andrew Shafer](http://twitter.com/littleidea).
...
I was still in the Bay Area on july the 6th when the first Silicon Valley Devops Meetup was organized by [Dave Nielsen](http://twitter.com/davenielsen) in Mountain View and I decided to join attend their first meetup.

Although Patrick and I have been in contact and working on presentations about "Agile and Operations" and "Continuous Deployment pipelines" months before he pinned the devops term and decided to create the [first Devopsdays](http://www.devopsdays.org/ghent09/), we don't live close enough to one another to be able to see each other regularly, and I don't know yet enough devops-minded people locally to be able to start regular meetups, so it was interesting for me to to see what form it would take (sadly I haven't managed to attend to the [popular london meetups](http://londondevops.org/) yet).
...
I guess I felt that I was passing on the torch somehow and since some of the topics and discussions that took place during (and after) [Devopsdays](http://www.devopsdays.org/ghent09/) came back, it was an opportunity to share what was said and done back then. I think that the biggest benefit the devops movement is that it enables people to share their experience with one another, and I believe this is one of the way we can solve the problem I addressed on my [previous post]({{< relref "posts/on-the-shortcomings-of-systems-and-networks-engineers-training.md" >}}).

One of the things from Ghent that I mentioned was the very nice experiment by [Lindsay Holmwood](http://twitter.com/auxesis) when he proposed a [1-hour gang-development session on "cucumber as a script language"](http://holmwood.id.au/~lindsay/2009/11/01/using-cucumber-as-a-scripting-language/). Not only because the subject was cool, but also because there was actually concrete code produced after this session, and I believe this is great if we can not only exchange ideas but also produce something that goes in the right direction.
...
Before I was involved in the devops movement, I was very much influenced by the Agile community, thanks to my friend [Raphaël Pierquin](http://twitter.com/perafoo) (I also met Patrick thanks to him). He is the one who introduced me to the notion of ["Coding Dojos"](http://www.agiledesign.co.uk/technical/dojo-kata-or-randori/).
