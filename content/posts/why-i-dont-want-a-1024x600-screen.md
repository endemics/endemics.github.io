...
I know this is slightly off topic, but I've been complaining a lot lately about 1024x600 screens on [twitter](http://www.twitter.com/endemics) and I probably need to explain why :)
...
I might not want an apple device for other reasons, but I don't think 1024x768 is a [bastard size](http://www.techeye.net/hardware/ipad-display-is-a-bastard-screen-size). It certainly was the standard not long ago on CRTs or LCD. So much in fact that (for worse more than for bad) almost all websites are designed for that size.
